...
import { Star, Heart, Eye, ShoppingBag, Flame, SlidersHorizontal, ArrowUpDown } from "lucide-react";
...
export default function BestsellersPage() {
  ...
  const bestSellers = sourceProducts.filter((p) => p.isBestSeller || p.best_seller);
  const displayItems = bestSellers.length > 0 ? bestSellers : sourceProducts;
  ...
  return (
    <div className="bg-slate-50 min-h-screen font-sans space-y-10 pb-20">
      ...
      <section className="bg-gradient-to-r from-[#0b3b82] via-[#092a5e] to-[#b30047] text-white py-14 sm:py-20 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 text-center space-y-3 relative z-10">
          <span className="inline-flex items-center gap-2 bg-amber-400/20 border border-amber-300/30 text-amber-300 font-bold text-xs px-4 py-1.5 rounded-full uppercase tracking-wider">
            <Flame className="w-4 h-4 text-amber-400" /> Customer Favorites
          </span>
          ...
          <p className="max-w-2xl mx-auto text-blue-100 text-xs sm:text-sm leading-relaxed">
            Discover our top-rated organic foods, skin care serums, and natural supplements loved by thousands.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 space-y-8">
        ...
        {/* Product Grid (1 on Mobile, 2 on Small, 3 on Tablet, 5 on Desktop) */}
            ...
            >
              ...
              <div>
                ...
                <div className="flex items-center gap-1 mb-2">
                  ...
                  <span className="text-[10px] font-bold text-slate-400 ml-1">({prod.reviewsCount || 12})</span>
                </div>
