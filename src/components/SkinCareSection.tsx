            ...
            >
              <div>
                ...
                <div className="w-full h-44 bg-white rounded-lg flex items-center justify-center overflow-hidden relative mb-4">
                  ...
                  <div className="absolute top-2 right-2 flex flex-col gap-2 z-20 opacity-0 group-hover/skin:opacity-100 transition-all duration-300 translate-x-3 group-hover/skin:translate-x-0">
                    <button 
                      type="button"
